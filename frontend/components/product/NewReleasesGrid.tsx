      ...
      <Link href={`/products/${product.id}`} style={{ textDecoration: 'none', color: 'inherit' }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
          ...
          <motion.p
            ...
            style={{ fontSize: '12px', fontWeight: 600, letterSpacing: '0.12em', textTransform: 'uppercase', margin: 0 }}
          >
            {product.name}
          </motion.p>
          <motion.p
            ...
            style={{ fontSize: '12px', color: 'var(--fg-muted)', letterSpacing: '0.05em', margin: 0 }}
          >
            ${product.price.toFixed(2)}
          </motion.p>
        </div>
